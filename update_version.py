...
def replace_version(config_path, new_version, line_heading, needsPunctuation='', needsTab=""):
    ...
    with open(config_path, "r") as f:
        ...
        for line in config.split("\n"):
            ...
            if line_heading in line:
                new_line = f'{"\t" if needsTab else ""}{line_heading}{needsPunctuation}{new_version}{needsPunctuation}'
...
replace_version("config/bcc-common.toml", new_version, "modpackVersion = ", needsPunctuation='"', needsTab=True)
