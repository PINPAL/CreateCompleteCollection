...
ClientEvents.highPriorityAssets((event) => {
	const addNBTtoJEI = [
		...
		Item.of("cosmic_contraptions:radiant_knife", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_paxel", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_sword", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_hoe", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_helmet", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_chestplate", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_leggings", "{Unbreakable:1b}"),
		Item.of("cosmic_contraptions:radiant_boots", "{Unbreakable:1b}"),
	];
