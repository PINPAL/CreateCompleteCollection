StartupEvents.registry("block", (event) => {
	event
		.create("create_cc:rainbow_placard")
	...
	event
		.create("create_cc:rainbow_candle")
	...
	event
		.create("create_cc:rainbow_canvas_sign")
	...
	event
		.create("create_cc:rainbow_wool")
		.displayName("Rainbow Wool")
		.soundType("wool")
		.tagBlock("minecraft:mineable/paxel");

	event
		.create("create_cc:rainbow_concrete")
		.displayName("Rainbow Concrete")
		.soundType("stone")
		.tagBlock("minecraft:mineable/pickaxe");

	event
		.create("create_cc:rainbow_valve_handle")
...
StartupEvents.registry("item", (event) => {
	event.create("create_cc:rainbow_core").displayName("Rainbow Core").unstackable();
	event.create("create_cc:rainbow_dye").displayName("Rainbow Dye");
	event.create("create_cc:rainbow_toolbox").displayName("Rainbow Toolbox").unstackable();
});
