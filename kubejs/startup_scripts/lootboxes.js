global.lootboxes = {
	...
	steel: {
		...
		items: [
			...
			{
				item: "destroy:bubble_cap",
				weight: 1,
			},
			{
				item: "destroy:vat_controller",
				weight: 1,
			},
			{
	...
	decorative: {
		...
		items: [
			...
			{
				item: "createdeco:verdant_bricks",
				weight: 2,
			},
			{
