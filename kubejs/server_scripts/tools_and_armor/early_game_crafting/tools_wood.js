ServerEvents.recipes((event) => {
	...
	event
		...
		.id("cosmic_contraptions:wooden_paxel_crafting");
	event
		.shaped("minecraft:wooden_hoe", ["AA ", " B ", " B "], {
			A: "#minecraft:planks",
			B: "#forge:rods/wooden",
		})
		.id("cosmic_contraptions:wooden_hoe_crafting");
	event
		.shaped("minecraft:wooden_sword", [" A ", " A ", " B "], {
			A: "#minecraft:planks",
			B: "#forge:rods/wooden",
		})
		.id("cosmic_contraptions:wooden_sword_crafting");
	event
		.shaped("moredelight:wooden_knife", ["   ", " A ", " B "], {
			A: "cosmic_contraptions:wooden_blade",
			B: "#forge:rods/wooden",
		})
		.id("cosmic_contraptions:wooden_knife_crafting");
